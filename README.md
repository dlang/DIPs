...
The [guidelines](https://github.com/dlang/DIPs/blob/master/GUIDELINES.md) provide advice on how to write a proper DIP. Ignoring it reduces the chance of a DIP being accepted into the repository.
