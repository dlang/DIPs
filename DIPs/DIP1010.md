...
Regarding Proposal 1, they find it integrates well with the rest of the language and falls wihin the spirit of D. They see it as more of the removal of a limitation than the addition of a feature, and like that it reuses the syntax and semantics of existing language entities (`alias` and `enum`). They see Proposal 2 as the core of the DIP, finding that it is well-motivated and liking that it resuses elements of Proposal 1.
