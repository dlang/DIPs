...
[has been made an error](https://dlang.org/changelog/2.079.0.html#comma-deprecation-error) as of March 2018, we are able to make progress on this first step
toward full tuple support in the D language.
