...
[A previous proposal, DIP 1017](https://github.com/dlang/DIPs/blob/master/DIPs/rejected/DIP1017.md), was rejected.
That DIP did not explore use cases of the bottom type beyond specifying that a function will not return. This DIP aims to improve upon that.
...
A big problem with this comparison is that mathematical functions are defined to give an answer, while a computer has to perform computations [[1]](#reference).
